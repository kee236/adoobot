...
(
  ...
  // ** เพิ่มโค้ดใหม่สำหรับระบบ E-commerce ที่เราปรับปรุง **
  base_url("ecommerce/payment_settings") => base_url("ecommerce"),
  base_url("ecommerce/shipping_settings") => base_url("ecommerce")
