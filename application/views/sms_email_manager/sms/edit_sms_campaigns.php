...
<?php if(isset($google_contacts_account) &&  $google_contacts_account!= "")

{ ?>

    <script type="text/javascript">setTimeout(function() {$("#google_contacts_id").trigger('change');}, 2000);</script>
                                    ...
                                    <div class="row">
                                        ...
                                        <?php if ( $this->basic->is_exist("add_ons",array("project_id"=>72)) && ($this->session->userdata('user_type') == 'Admin' || in_array(353, $this->module_access))){ ?>           
                                            <div class="col-12 col-md-6">
                                                <div class="card card-primary">
                                                    <div class="card-header">
                                                        <h4><?php echo $this->lang->line('SMS Subscriber (Google Contacts)'); ?></h4>
                                                    </div>
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            <ul class="list-group">
                                                                <div class="row">
                                                                    <div class="col-12 col-md-6">
                                                                        <li class="list-group-item d-flex justify-content-between align-items-center pointer" title='<?php echo $this->lang->line('Total Contact Group Numbers'); ?>'>
                                                                        <?php echo $this->lang->line("Google Contact Numbers"); ?> 
                                                                        <span class="badge badge-primary" id="google_contact_numbers">0</span>
                                                                        </li>
                                                                    </div>
                                                                </div>
                                                            </ul>
                                                        ...
                                                        <div class="form-group">
                                                            <label><?php echo $this->lang->line('Select Google Contacts account'); ?> </label>
                                                            <select multiple="multiple"  class="form-control select2" id="google_contacts_id" name="google_contacts_id[]" style="width:100%;">
                                                                <?php
                                                                foreach($google_contacts_account as $key=>$value)
                                                                {
                                                                    if(in_array($key,$selected_google_contacts_account)) echo $checked = "selected";
                                                                    else echo $checked = "";
