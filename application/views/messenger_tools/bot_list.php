                          ...
                          <div class="modal-content no_shadow">
                              <div class="modal-body padding-0 ">
                                    ...
                                    <?php if ($this->basic->is_exist("add_ons",array("project_id"=>70)) && ($this->session->userdata('user_type') == 'Admin' || in_array(351, $this->module_access))){ ?>
                                      <div class="section">                
                                            <h2 class="section-title"><?php echo $this->lang->line('Google Sheet Integration'); ?> <span style="font-size: 12px !important;"><a href="<?php echo base_url('google_sheet'); ?>" target="_BLANK"><?php echo $this->lang->line('Add Google Sheet'); ?></a></span></h2>
                                            <p><?php echo $this->lang->line('Append collected subscriber to google sheet.'); ?></p>
                                          </div>
                                          <div class="form-group">
                                            <label style="width: 100%;">
                                              <?php echo $this->lang->line("Select Google Sheet List"); ?>
                                              <a href="" class="text-danger float-right error_log_report2" data-type="Email Autoresponder" data-service="GoogleSheet"><i class="fas fa-history"></i> <?php echo $this->lang->line('API Log'); ?></a>                                        
                                            </label>
                                              ...
                                              foreach ($google_sheet_list as $email => $sheets) {
                                                ...
                                                foreach ($sheets as $sheet) {
                                                  ...
                                                  foreach ($sheet_tab_names as $sheet_tab) {
                                                    $selected = '';
                                                    if (!empty($selected_google_sheet_list_ids)) {
                                                      if(in_array($sheet['id'].'-'.$sheet_tab, $selected_google_sheet_list_ids)) {
                                                        $selected = 'selected';
                                                      }
                                                    }
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $("#mailchimp_list_id,#sms_api_id,#email_api_id,#sendinblue_list_id2,#activecampaign_list_id2,#mautic_list_id2,#acelle_list_id2,#google_sheet_list").select2({ width: "100%" });
    ...
    $(document).on('click','#mark_seen_save_button',function(e){
      ...
      var google_sheet_list = $("#google_sheet_list").val();
